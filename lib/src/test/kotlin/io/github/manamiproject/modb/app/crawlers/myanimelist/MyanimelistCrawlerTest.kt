...
internal class MyanimelistCrawlerTest {
    ...
    inner class StartTests {
        ...
        fun `doesn't do anything if the list of IDs is empty`() {
            ...
            val crawler = MyanimelistCrawler(
        ...
        fun `successfully loads multiple entries`() {
            tempDirectory {
                // given
                val testMetaDataProviderConfig = object: MetaDataProviderConfig by MyanimelistConfig {
    ...
    inner class CompanionObjectTests {
        ...
        fun `instance property always returns same instance`() {
            tempDirectory {
                // given
                val previous = MyanimelistCrawler.instance

                // when
                val result = MyanimelistCrawler.instance
