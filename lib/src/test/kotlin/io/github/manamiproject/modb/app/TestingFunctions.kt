...
internal fun createExpectedDatasetPrettyPrint(vararg data: String): String {
    ...
    return """
        {
          "${'$'}schema": "https://raw.githubusercontent.com/ipkpjersi/anime-offline-database/refs/tags/2020-01/anime-offline-database.schema.json",
          "license": {
...
internal fun createExpectedDatasetMinified(vararg data: String): String {
    ...
    return """
        {"${'$'}schema":"https://raw.githubusercontent.com/ipkpjersi/anime-offline-database/refs/tags/2020-01/anime-offline-database-minified.schema.json","license":{"name":"Open Data Commons Open Database License (ODbL) v1.0 + Database Contents License (DbCL) v1.0","url":"https://github.com/ipkpjersi/anime-offline-database/blob/2020-01/LICENSE"},"repository":"https://github.com/ipkpjersi/anime-offline-database","scoreRange":{"minInclusive":1.0,"maxInclusive":10.0},"lastUpdate":"2020-01-01","data":[$joinedData]}
    """.trimIndent()
}
...
internal fun createExpectedDeadEntriesPrettyPrint(vararg data: String): String {
    ...
    return """
        {
          "${'$'}schema": "https://raw.githubusercontent.com/ipkpjersi/anime-offline-database/refs/tags/2020-01/dead-entries/dead-entries.schema.json",
          "license": {
            "name": "Open Data Commons Open Database License (ODbL) v1.0 + Database Contents License (DbCL) v1.0",
            "url": "https://github.com/ipkpjersi/anime-offline-database/blob/2020-01/LICENSE"
          },
