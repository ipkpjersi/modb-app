    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                packaging = "jar"
                name.set(moduleName)
                description.set("This lib contains downloader and converter for downloading raw data from anisearch.com and convert it to an anime object.")
