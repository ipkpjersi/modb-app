...
internal class DatasetTest {
    ...
    fun `default values`() {
        ...
        assertThat(result.license.url).isEqualTo(URI("https://github.com/ipkpjersi/anime-offline-database/blob/master/LICENSE"))
        assertThat(result.repository).isEqualTo("https://github.com/ipkpjersi/anime-offline-database")
